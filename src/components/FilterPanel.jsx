...
export default function FilterPanel({ filters, onChange, availableTags, onClose, isOpen = true }) {
        ...
        return (
            <>
                ...
                <motion.div
                    ...
                    className="fixed bottom-0 left-0 right-0 z-50 bg-zinc-900 border-t border-zinc-800 rounded-t-2xl max-h-[80vh] overflow-auto"
                >
                    {/* Drag Handle */}
