...
export default function FeedbackWidget() {
    ...
    return (
        <>
            ...
            {/* Modal Overlay & Content - Rendered in Portal */}
            {createPortal(
                <AnimatePresence>
                    {isOpen && (
                        <>
                            ...
                            <div className="fixed inset-0 z-[101] flex items-center justify-center p-4 pointer-events-none">
                                <motion.div
                                    ...
                                    className="w-full max-w-md bg-zinc-900 border border-zinc-700 rounded-2xl shadow-2xl overflow-hidden max-h-[80vh] flex flex-col pointer-events-auto"
                                >
                                    {/* Header */}
                                    ...
                                    {status === 'success' ? (
                                        ...
                                        <form onSubmit={handleSubmit} className="p-4 space-y-4 overflow-y-auto custom-scrollbar flex-1 min-h-0">
